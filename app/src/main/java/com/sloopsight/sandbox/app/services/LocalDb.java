...
public class LocalDb {
    ...
    public void set(@ParamHint("key") String key,@ParamHint("value as object") Object value,@ParamHint("Time To Live in Seconds") int ttl) {
    ...
    @MethodHint(name = "getAll",comment = "get value in db")
